...
public class Grafo {
    ...
    public String encontrarRutaMinimaDijkstra(String inicio, String fin) {
        ...
        int distancia = tmp.getDistancia();
    ...
    public void encontrarRutaMinimaDijkstra(String inicio) {
        ...
        while (!cola.isEmpty()) {        // mientras que la cola no esta vacia
            ...
            int p = posicionNodo(tmp.getNombre());
            for (int j = 0; j < grafo[p].length; j++) {  // revisa los nodos hijos del nodo tmp
                ...
                Nodo nod = new Nodo(nodos[j], tmp.getDistancia() + grafo[p][j], tmp);
                ...
                for (Nodo x : cola) {
                    ...
                    if (x.equals(nod) && x.getDistancia() > nod.getDistancia()) {
